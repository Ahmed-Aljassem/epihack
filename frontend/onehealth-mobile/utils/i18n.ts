...
export const I18N = {
  EN: {
    ...
    v_temp: 'Temperature', v_air: 'Air Quality', v_pol: 'Pollen', v_uv: 'UV Index', v_hum: 'Humidity', resource_prompt: 'Submit a report to get matched health resources.', resource_open_report: 'Start a report', resource_close: 'Close', resource_nation_button: "Tohono O'odham Resources",
  ...
  ES: {
    ...
    v_temp: 'Temperatura', v_air: 'Calidad del aire', v_pol: 'Polen', v_uv: 'Índice UV', v_hum: 'Humedad', resource_prompt: 'Envía un reporte para recibir recursos relacionados.', resource_open_report: 'Comenzar reporte', resource_close: 'Cerrar', resource_nation_button: "Tohono O'odham Resources",
  ...
  TO: {
    ...
    dash_quick: 'A:g haicu', dash_impact: 'Ap s-ap', dash_recent: 'Hemaajkam a:g', dash_resources: 'Resources for you',
    ...
    v_temp: 'Ton', v_air: 'Hevel', v_pol: 'Pollen', v_uv: 'UV Index', v_hum: 'Humidity', resource_prompt: 'Submit a report to get matched health resources.', resource_open_report: 'Start a report', resource_close: 'Close', resource_nation_button: "Tohono O'odham Resources",
