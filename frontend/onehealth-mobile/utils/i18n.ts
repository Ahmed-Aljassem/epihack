...
export const I18N = {
  EN: {
    ...
    dash_quick: 'Quick report', dash_impact: 'Your impact', dash_recent: 'Recent near you', dash_resources: 'Resources for you',
    rep_sub: 'Reports submitted', see_all: 'See all reports', p_prof: 'Profile', p_anon: 'Anonymous Reporter', p_signup: 'Sign Up', p_impact: 'Your impact', p_rec: 'Recent reports', p_no_rep: 'No reports yet', p_sent: 'Sent', p_set: 'Settings', p_lang: 'Language', p_loc: 'Location', p_notif: 'Notifications', p_app: 'Appearance', p_about: 'About', p_how: 'How OneHealth Works', p_priv: 'Privacy Policy', p_ai: 'How Our AI Works', p_feed: 'Send Feedback', p_logout: 'Log Out', 
    v_temp: 'Temperature', v_air: 'Air Quality', v_pol: 'Pollen', v_uv: 'UV Index', v_hum: 'Humidity',
    res_placeholder_title: 'Report symptoms to unlock resources', res_placeholder_body: 'We will match your latest report to local guidance and surveillance links.', res_based_on: 'Based on your report from', res_open_map: 'View current activity map', res_submit_report: 'Report symptoms', res_pima_data: 'Pima County data', res_az_dashboard: 'Arizona dashboard', res_cdc_rmsf: 'CDC tick-bite guide', res_call_911: 'Call 911',
  ...
  ES: {
    ...
    dash_quick: 'Reporte rápido', dash_impact: 'Tu impacto', dash_recent: 'Reciente cerca de ti', dash_resources: 'Recursos para ti',
    rep_sub: 'Reportes enviados', see_all: 'Ver todos los reportes', p_prof: 'Perfil', p_anon: 'Reportador Anónimo', p_signup: 'Regístrate', p_impact: 'Tu impacto', p_rec: 'Reportes recientes', p_no_rep: 'Sin reportes', p_sent: 'Enviado', p_set: 'Ajustes', p_lang: 'Idioma', p_loc: 'Ubicación', p_notif: 'Notificaciones', p_app: 'Apariencia', p_about: 'Acerca de', p_how: 'Cómo funciona', p_priv: 'Privacidad', p_ai: 'Nuestra IA', p_feed: 'Enviar comentarios', p_logout: 'Cerrar Sesión',
    v_temp: 'Temperatura', v_air: 'Calidad del aire', v_pol: 'Polen', v_uv: 'Índice UV', v_hum: 'Humedad',
    res_placeholder_title: 'Reporta síntomas para ver recursos', res_placeholder_body: 'Relacionaremos tu reporte más reciente con guías locales y enlaces de vigilancia.', res_based_on: 'Basado en tu reporte del', res_open_map: 'Ver mapa de actividad', res_submit_report: 'Reportar síntomas', res_pima_data: 'Datos del condado', res_az_dashboard: 'Panel de Arizona', res_cdc_rmsf: 'Guía CDC de garrapatas', res_call_911: 'Llamar al 911',
  ...
  TO: {
    ...
    dash_quick: 'A:g haicu', dash_impact: 'Ap s-ap', dash_recent: 'Hemaajkam a:g', dash_resources: 'Resources',
    rep_sub: 'O\'ohan', see_all: 'Ñei', p_prof: 'Profile', p_anon: 'Pi-mah o\'ohan', p_signup: 'O\'ohan', p_impact: 'Ap s-ap', p_rec: 'O\'ohan m-ap', p_no_rep: 'Pi o\'ohan', p_sent: 'Sent', p_set: 'Settings', p_lang: 'Ñiok', p_loc: 'Hebai', p_notif: 'Notifs', p_app: 'Appearance', p_about: 'About', p_how: 'How OneHealth Works', p_priv: 'Privacy', p_ai: 'AI', p_feed: 'Feedback', p_logout: 'Log Out',
